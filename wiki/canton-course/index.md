...
- **해외송금** — 국내 기관 A가 해외 기관 B에게 가치를 한 방향으로 보낸다.
...
| 단계 | 제목 | 핵심 질문 |
|---|---|---|
| [S0](s00-opening.md) | 오프닝: 한 건의 가치 이동 | 이 한 건이 무엇을 불러내나? |
...
➡️ **다음**: [S0 — 오프닝: 한 건의 가치 이동](s00-opening.md)
