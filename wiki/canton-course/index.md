...
```mermaid
flowchart LR
  A["국내 기관 A"] -->|"주축 송금, 한 방향"| B["해외 기관 B"]
  A -.->|"통화 X"| B
  B -.->|"통화 Y 동시, 고급 정산"| A
```
...
| [S9](s09-architecture.md) | 아키텍처 & 합의·확정 | 무엇을 띄우고 어떻게 연결되며, 되돌릴 수 없나? |
| [S10](s10-recap.md) | 정리·실습·심화 | 언제 Canton이 맞고, 언제 안 맞나? |

> 시작: [S1 — 국경 간의 두 고통](s01-problem.md)

<!-- nav:start -->

---

➡️ **다음**: [S1 — 국경 간의 두 고통](s01-problem.md)
