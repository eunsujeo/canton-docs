...
## 질문
**국내 기관 A가 해외 기관 B에게 자금을 보낸다. 이 한 건이 무엇을 불러낼까?**

## 기초

이 코스 전체를 관통하는 사건은 단순하다.

> 국내 기관 A가 해외 기관 B에게 **자금을 보낸다.**
...
```mermaid
flowchart LR
  A["국내 기관 A"] -->|"주축 송금: 자금 한 방향"| B["해외 기관 B"]
  A -.->|"통화 X"| B
...
## 강의 노트
- **핵심 한 문장**: "A가 B에게 자금을 보낸다 — 이 한 건을 끝까지 따라가면 Canton의 모든 개념이 나온다."
- **비유**: 추리 소설의 첫 장면. 사건(자금 이동)을 던지고, 각 단계가 단서를 하나씩 푼다.
