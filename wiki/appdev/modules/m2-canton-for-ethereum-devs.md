...
이는 프라이버시의 직접적 결과다. Charlie가 온-<abbr class="gloss" title="거래·컨트랙트가 기록되는 장부. Canton에선 활성 컨트랙트의 모음">원장</abbr>에서 Alice의 데이터를 볼 수 없다면, Charlie의 노드에는 조회할 Alice의 데이터가 없다.
