...
| **L1 (레이어 1)** | 자체 합의로 트랜잭션을 직접 확정하는 기반 블록체인 | **자체 합의** | Bitcoin, Ethereum, Solana, **Canton** |
...
⬅️ **이전**: [블록체인 개발자를 위한 Canton (모듈 2)](../appdev/modules/m2-canton-for-ethereum-devs.md) ・ ➡️ **다음**: [eUTXO와 이중지불 방지 — "존재하지 않는 것은 쓸 수 없다" 쉽게 이해하기](eutxo-double-spend.md)
