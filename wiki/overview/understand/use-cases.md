...
- **핵심 용어**: DvP(Delivery vs. Payment), 원자적 정산(atomic settlement), 이해관계자(stakeholder), 선택적 공개(selective disclosure)
...
* **사적(Private)**: 관찰자는 거래 상대방이나 가격을 보면 안 됨
...
단일 원자적 트랜잭션이 두 컨트랙트를 모두 생성할 수 있다. 물류 제공자와 금융기관은 각자 관련된 컨트랙트만 보고, 출하인과 수취인(둘 다의 서명자)은 모든 것을 본다. 공급망의 하류 참여자는 상류 가격을 결코 보지 못한다. 그 컨트랙트들은 이해관계자가 다르기 때문이다.
