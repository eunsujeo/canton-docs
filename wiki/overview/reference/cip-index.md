...
| [CIP-0062](https://github.com/global-synchronizer-foundation/cips/blob/main/cip-0062/cip-0062.md) | <abbr class="gloss" title="상태를 저장하지 않고 트랜잭션 합의·순서를 조율하는 Canton 구성요소">Synchronizer</abbr> Migration with Downtime to Splice 0.4.0 / Canton 3.3 | Final |
...
<!-- nav:start -->
---
<sub>⬅️ **이전**: ["CIP-0056: Canton Network 토큰 표준"](cip-0056.md) ・ ➡️ **다음**: [크로스-Synchronizer DvP 예시](cross-sync-dvp-example.md)</sub>
<!-- nav:end -->
