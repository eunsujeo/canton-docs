...
미디에이터는 글로벌 동기화자의 트랜잭션에 대한 2단계 커밋 프로토콜을 촉진한다. 트랜잭션에 관여하는 <abbr class="gloss" title="어떤 컨트랙트와 관계를 맺어 그것을 보거나 승인하는 파티 = 서명자 + 관찰자">이해관계자</abbr> 참여자로부터 확인 평결을 수집하고, 그 평결을 집계하고, 트랜잭션 결과(커밋 또는 거부)를 선언한다.
